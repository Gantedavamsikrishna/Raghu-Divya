...
!(function (t, e) {
    ...
    (e.getMaximalFreeRects = function (e) {
      ...
      return (
        this.y < e.y &&
          ...
          s.push(i)),
        r > n &&
          ((i = new t({ x: n, y: this.y, width: r - n, height: this.height })),
          s.push(i)),
        h > o &&
          ((i = new t({ x: this.x, y: o, width: this.width, height: h - o })),
          s.push(i)),
        this.x < e.x &&
          ((i = new t({
            x: this.x,
  ...
  (function (t, e) {
    ...
    (n._create = function () {
      ...
      (n.shiftLayout = function () {
        (this.isShifting = !0), this.layout(), delete this.isShifting;
      }),
      (n._getPackMethod = function () {
        return this._getOption("horizontal") ? "rowPack" : "columnPack";
      }),
      (n._setMaxXY = function (t) {
        (this.maxX = Math.max(t.x + t.width, this.maxX)),
          (this.maxY = Math.max(t.y + t.height, this.maxY));
      }),
      (n._setRectSize = function (e, i) {
        var s = t(e),
          r = s.outerWidth,
          h = s.outerHeight;
        (r || h) &&
      ...
      (n._applyGridGutter = function (t, e) {
      ...
      (n.sortItemsByPosition = function () {
        var t = this._getOption("horizontal") ? a : o;
        this.items.sort(t);
      }),
      (n.fit = function (t, e, i) {
      ...
      (n.resizeShiftPercentLayout = function () {
      ...
      (n.updateShiftTargets = function (t) {
        ...
        if ((a = a && a + this.gutter)) {
          ...
          (r = this.shiftPacker[o] + this.gutter - t.rect[o]),
        ...
        g.forEach(function (t) {
          ...
          var i = h ? e.x + e.width : e.x,
            s = h ? e.y : e.y + e.height;
          if ((this._addShiftTarget(i, s, r), a))
            for (var n = Math.round(e[o] / a), c = 1; c < n; c++) {
              var u = h ? i : e.x + a * c,
                d = h ? e.y + a * c : s;
    ...
    (n.itemDragMove = function (t, e, i) {
      ...
      (n.bindDraggabillyEvents = function (t) {
        this._bindDraggabillyEvents(t, "on");
      }),
      (n.unbindDraggabillyEvents = function (t) {
        this._bindDraggabillyEvents(t, "off");
      }),
      (n._bindDraggabillyEvents = function (t, e) {
        var i = this.handleDraggabilly;
        t[e]("dragStart", i.dragStart),
          t[e]("dragMove", i.dragMove),
          t[e]("dragEnd", i.dragEnd);
      }),
      (n.bindUIDraggableEvents = function (t) {
        this._bindUIDraggableEvents(t, "on");
      }),
      (n.unbindUIDraggableEvents = function (t) {
        this._bindUIDraggableEvents(t, "off");
      }),
      (n._bindUIDraggableEvents = function (t, e) {
    ...
    return (
      (s._getOption = function (t) {
        return "horizontal" == t
          ...
          : c.apply(this.isotope, arguments);
      }),
      i
    );
  });
...
!(function (t) {
  ...
  function i(t) {
    for (var e = [], i = t.length, r = t[0].length, n = 0; i > n; n++)
      e = e.concat(t[n]);
    e = s(e);
  ...
  (r.prototype.options = {
    ...
    (r.prototype._open = function (t) {
      ...
      t
        ? (i.removeEventListener("click", open),
          classie.removeClass(i, "photostack-start"),
          s())
        : ((e.openDefault = !0), setTimeout(s, 25)),
        (e.started = !0),
        e._showPhoto(e.current);
    }),
    (r.prototype._initEvents = function () {
      "true" == this.options.clickToFlip &&
    ...
    (r.prototype._resizeHandler = function () {
      ...
      this._resizeTimeout && clearTimeout(this._resizeTimeout),
        (this._resizeTimeout = setTimeout(t, 100));
    }),
    (r.prototype._resize = function () {
      ...
      this._getSizes(),
        this.started && this.flipped ? this._rotateItem(e) : e();
    }),
    ...
    (r.prototype._shuffle = function (t) {
      ...
      (0 >= e || !this.started || this.openDefault) && (e = 1),
        this.openDefault &&
      ...
      var s = 0.5,
        ...
        h =
          r * this.sizes.item.width * s +
          this.sizes.item.width / 2 -
          this.sizes.inner.width,
        l =
          o * this.sizes.item.height * s +
        ...
        d = function () {
          ...
          for (var t = [], h = 0; o > h; ++h)
            for (var l = (t[h] = []), v = 0; r > v; ++v) {
              var g = v * (m.sizes.item.width * s) - c,
                ...
                x = 0;
              if (m.started && 0 === e) {
                var z = m._isOverlapping({ x: g, y: y });
                if (z.overlapping) {
          ...
          m.allItems.forEach(function (i, s) {
            ...
            var h =
              ...
              c = function () {
                ++C,
                  n.transitions && this.removeEventListener(a, c),
                  C === m.allItemsCount &&
                    (e > 0
                      ? d.call()
            ...
            m.items.indexOf(i) === m.current && m.started && 0 === e
              ...
              : ((i.style.WebkitTransform =
                  ...
                  l.y +
                  "px) rotate(" +
                  Math.floor(Math.random() * (f - u + 1) + u) +
                  "deg)"),
                (i.style.msTransform =
                  "translate(" +
                  l.x +
                ...
                (i.style.transform =
                  ...
                  Math.floor(Math.random() * (f - u + 1) + u) +
                  "deg)")),
              m.started && (n.transitions ? i.addEventListener(a, c) : c());
          });
        };
      d.call();
    }),
    ...
    (r.prototype._isOverlapping = function (t) {
      ...
      if (!(t.x + r < s.x || t.x > s.x + e || t.y + n < s.y || t.y > s.y + i)) {
        ...
        return { overlapping: !0, noOverlap: { x: l, y: c } };
      }
    ...
    (r.prototype._rotateItem = function (t) {
      if (
        ...
        var e = this,
          i = function () {
            n.transitions && n.preserve3d && this.removeEventListener(a, i),
              (e.isRotating = !1),
              "function" == typeof t && t();
          };
        this.flipped
          ...
          n.transitions && n.preserve3d
            ? this.currentItem.addEventListener(a, i)
            : i();
      }
    }),
    (t.Photostack = r);
